...
SBUTTON_CLICK SButton::update()
{
      ...
      if (pin_state == LOW && State == false && (ms - Ms1) > TM_bounce)
      {
            ...
            State = true;
            Ms2 = ms;
            if (TM_long_click == 0 && TM_auto_click == 0)
                  return SB_CLICK;
      }
      ...
      if (pin_state == LOW && TM_auto_click > 0 && (ms - Ms2) > TM_auto_click && (ms - Ms_auto_click) > Period_auto_click)
      {
            uint16_t dt = ms - Ms2;
      ...
      if (pin_state == HIGH && State == true && (ms - Ms2) > TM_bounce)
      {
            ...
            if ((TM_long_click != 0 || TM_auto_click != 0) && !Long_press_state && !Auto_press_state)
                  return SB_CLICK;
      }
      return SB_NONE;
}
